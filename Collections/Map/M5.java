...
// 1. Develop a java class with a instance variable M5 (TreeMap)  create a method
// saveCountryCapital(String CountryName, String capital) , the method should add the passed country and
// capital as key/value in the map M5 and return the Map (M5).
//Key- Country                          Value - Capital
//India                                                   Delhi
//Japan                                                Tokyo
//2. Develop a method getCapital(String CountryName) which returns the capital for the country passed, from the
// Map M5 created in step 1.
//3. Develop a method getCountry(String capitalName) which returns the country for the capital name,
// passed from the Map M5 created in step 1.
//4. Develop a method which iterates through the map M5 and creates another map M2 with Capital as the key and value
// as Country and returns the Map M2.
//Key – Capital                    Value – Country
//Delhi                                           India
//Tokyo                                        Japan
//5. Develop a method which iterates through the map M5 and creates an ArrayList with all the Country names stored as keys.
...
public class M5 {
    ...
    TreeMap<String,String> saveCountryCapital(String CountryName, String Capital){
        M5.put(CountryName,Capital);
        return M5;
    }

    String getCapital(String CountryName){
        Iterator i=M5.entrySet().iterator();
        while (i.hasNext()){
    ...
    TreeMap<String,String> createNewMap(TreeMap<String,String> map1){
        Iterator iterator=map1.entrySet().iterator();
        TreeMap<String ,String> map2=new TreeMap<>();
        while (iterator.hasNext()){
            Map.Entry M5=(Map.Entry) iterator.next();
            map2.put((String) M5.getValue(),(String)M5.getKey());
        }
        return map2;
    }
...
// This method should return the ArrayList.
    ...
    ArrayList<String> createArrayList(TreeMap<String,String> map1){
    ...
    public static void main(String[] args) {
        ...
        Iterator iterator=map.createNewMap(map.M5).entrySet().iterator();
        ...
        arr=map.createArrayList(map.M5);
